...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_keyboard_visibility_temp_fork/flutter_keyboard_visibility_temp_fork.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/path_provider_foundation/path_provider_foundation.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/quill_native_bridge_ios/quill_native_bridge_ios.framework"
